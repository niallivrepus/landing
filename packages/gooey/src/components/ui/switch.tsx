...
export function Switch({
  ...
  const track = (
    <motion.button
      ...
      className={cn(
        "relative inline-flex h-10 w-16 shrink-0 cursor-pointer items-center rounded-[24px] p-0 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50",
        className
      )}
      style={{
        background: checked
        ...
        border: checked
          ? "2px solid var(--color-light-glass-40)"
          : "2px solid var(--color-light-glass-10)",
      ...
      <motion.span
        ...
        style={{
          ...
          background: checked
            ...
            : "var(--color-smoke-4)",
          border: checked
            ? "2px solid var(--color-dark-glass-10)"
    ...
    return (
      <div className="flex items-center gap-1">
        ...
        <motion.button
          ...
          whileTap={shouldAnimate ? { scale: 0.95 } : undefined}
          transition={getSpringTransition("microPop")}
          className="flex size-[42px] shrink-0 cursor-pointer items-center justify-center rounded-full focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
          style={{
            background: "var(--color-light-glass-5)",
            border: "2px solid var(--color-light-glass-20)",
            boxShadow:
              "0px 1px 4px rgba(0,0,0,0.1), inset 0px 0.3px 0.5px rgba(255,255,255,0.15)",
          }}
        >
          <IncognitoIcon
            size={20}
