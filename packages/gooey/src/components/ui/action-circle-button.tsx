...
export function ActionCircleButton({
  ...
  }, [variant, energy, active, gradient, effectiveHover, effectiveActive, config, pinned]);
  ...
  return (
    <button
      ...
      className="flex items-center justify-center shrink-0 cursor-pointer rounded-full focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background outline-none"
      style={style}
      {...props}
    >
      {count !== undefined ? (
        <span
          className="font-sans font-bold text-[16px] leading-[1.4]"
