...
function Radio({ checked = false, onChange, disabled, className }: RadioProps) {
  ...
  return (
    <button
      ...
      className={cn(
        "relative flex items-center justify-center min-w-[44px] min-h-[44px] rounded-full outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background",
