...
function VoiceMemo({
  ...
  return (
    <div
      ...
      className={cn(
        ...
        theme === "dark"
          ...
          : "border-2 border-light-glass-20 bg-light-glass-5 px-3",
        className,
      )}
    ...
    >
      {bars.map(({ index, height, isRecorded }) => (
        ...
        >
          <div
            ...
            style={{ boxShadow: "inset 0px 1px 1px 0px rgba(255, 255, 255, 0.15)" }}
          />
        </div>
      ))}
      ...
      <div
        className="pointer-events-none absolute inset-0 rounded-[inherit]"
        style={{ boxShadow: "inset 0px 2px 2px 0px rgba(255, 255, 255, 0.15)" }}
      />
    </div>
  );
}
