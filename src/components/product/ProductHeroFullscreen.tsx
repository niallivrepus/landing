 ...
 * Cinematic background, eyebrow + huge title centered at the bottom,
 * optional CTA cluster centered below the title.
 */
export function ProductHeroFullscreen({
  ...
  return (
    ...
    >
      ...
      <div className={cn(CONTENT_SHELL_WIDE, "relative z-20 flex flex-col items-center justify-end pb-12 pt-32 text-center md:pb-16 md:pt-40")}>
        ...
        <div className="flex w-full max-w-4xl flex-col items-center gap-6">
          ...
          <h1 className="font-sans text-[clamp(3.5rem,18vw,14rem)] font-light leading-[0.92] tracking-[-0.025em] text-white">
            {title}
          </h1>
          {trailing ? (
            <div className="flex flex-col items-center gap-3 sm:flex-row">{trailing}</div>
          ) : null}
        </div>
      </div>
    </section>
