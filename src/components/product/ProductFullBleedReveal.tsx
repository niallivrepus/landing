      ...
      <div className="sticky top-20">
        ...
        <div className="mt-10 flex justify-center pb-8 md:mt-14">
          <motion.div
            ...
            className="w-screen overflow-hidden border border-zinc-200/80 bg-[#FBFBFC] shadow-[0_40px_100px_rgba(15,23,42,0.08)] dark:border-white/[0.08] dark:bg-[#1C1C1E] dark:shadow-[0_40px_100px_rgba(0,0,0,0.42)]"
          >
