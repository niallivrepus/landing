...
export function DocumentTopicCard({
  ...
  return (
    <Link
      to={to}
      className={cn(
        "flex min-h-[140px] flex-col items-center justify-center gap-4 rounded-[2px] border bg-white/[0.04] px-4 py-6 font-sans transition-colors",
        selected
          ? "border-[var(--color-blue-4)] shadow-[inset_0_0_0_1px_var(--color-blue-4)]"
          : "border-light-glass-20 hover:border-light-glass-40 hover:bg-white/[0.06]",
      )}
    >
