...
export function FundersStrip() {
  return (
    <section
      className="border-t border-light-space/[0.07] bg-dark-space px-4 py-10 md:px-8 md:py-12"
          ...
          {FUNDERS.map((f) => (
            <li key={f.name}>
              <a
                ...
                className="font-sans text-sm font-medium text-light-space/60 transition-colors hover:text-light-space/90 md:text-[15px]"
              >
                {f.name}
              </a>
            </li>
