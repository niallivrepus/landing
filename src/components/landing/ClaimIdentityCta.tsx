...
export function ClaimIdentityCta({
  ...
  return (
    <a
      ...
      {...hoverSoundProps}
      className={cn(
        "inline-flex h-[50px] shrink-0 items-center justify-center rounded-full border-2 border-light-space/25 bg-white px-8 font-sans text-sm font-bold text-black",
