export const LANDING_PROMPT_BORDER_CLASS = "!border !border-solid !border-[#3A3A3C] light:!border-[#E0E0E0]";

export const LANDING_PROMPT_SHELL_CLASS =
  "relative flex h-[50px] items-center justify-between rounded-[9999px] border border-solid border-[#3A3A3C] bg-[#111111]/88 p-1 py-1 pl-1 pr-[5px] shadow-[0px_1px_4px_0px_rgba(0,0,0,0.1)] backdrop-blur-[25px] light:border-[#E0E0E0] light:bg-white light:shadow-[0px_1px_4px_0px_rgba(0,0,0,0.08)]";
