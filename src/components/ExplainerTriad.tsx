...
function IllustrationLayers() {
  return (
    <svg
      ...
      className="mx-auto h-[min(140px,28vw)] w-full max-w-[200px] text-light-space/35 light:text-zinc-500"
      aria-hidden
    >
    ...
    >
      ...
      <div className="mx-auto grid max-w-[1380px] grid-cols-1 gap-y-12 md:grid-cols-3 md:gap-x-8 md:gap-y-0 lg:gap-x-10">
        {ITEMS.map((item) => (
          ...
          >
            <p className="font-mono text-[11px] tracking-[0.12em] text-light-space/40 light:text-zinc-500">{item.fig}</p>
