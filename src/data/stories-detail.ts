...
export type StorySection =
  ...
  | {
      /** Embedded MP3 for editorial listen-along (Spine essays, founder voice). */
      kind: "audio";
      src: string;
      title: string;
      attribution?: string;
  ...
  | {
      /** Line-broken editorial poem with stanza spacing. */
      kind: "poem";
      stanzas: string[][];
    }
...
export const STORY_DETAILS: Record<string, StoryDetail> = {
  "the-next-version-of-freedom": {
    slug: "the-next-version-of-freedom",
    metaLine: "July 4, 2026 · Spine · Editorial",
    title: "The Next Version of Freedom",
    dek: "On Independence Day, Sean Rock reflects on digital sovereignty—and why Spine is an operating environment, not another app.",
    heroGallery: [
      {
        src: "/images/spine-freedom-flag.png",
        alt: "Metallic American flag sculpture against a dark sky",
        label: "Spine",
      },
    ],
    sections: [
      {
        kind: "audio",
        src: "/audio/sean-rock-independence-day.mp3",
        title: "Listen to the essay",
        attribution: "Sean Rock",
      },
      {
        kind: "poem",
        stanzas: [
          ["Today they call it Independence Day."],
          ["But I keep thinking —", "independence from what?"],
          [
            "From kings?",
            "From empires?",
            "From people who told you where to stand,",
            "what to say,",
            "what to believe,",
            "what to build,",
            "who to love,",
          ...
          ["America was born from a dangerous idea:"],
          ["That a human being", "should not have to ask permission", "to be free."],
          [
            "But freedom is not a flag.",
            "Freedom is not a holiday.",
            "Freedom is not a slogan printed on a shirt",
            "by a company that tracks your every move.",
          ],
          ["Freedom is an environment."],
          [
            "It is the space around you",
            "that either makes you powerful",
            "or makes you obedient.",
          ],
          [
            "And today, most people are not living free.",
            "They are scrolling inside cages",
            "designed to look like playgrounds.",
          ],
          [
            "Their thoughts are rented.",
            "Their attention is harvested.",
            "Their memories are buried.",
            "Their relationships are scattered across apps",
            "owned by people they will never meet.",
          ],
          ["So no —", "I'm not celebrating freedom like it already happened."],
          ["I'm interested in the next version of it."],
          [
            "The version where people own their presence.",
            "Where your conversations remember you.",
            "Where your community is not trapped inside someone else's machine.",
            "Where your identity is not a login.",
            "Where your voice does not disappear into a feed.",
            "Where your people, your creations, your history, and your future",
            "live in one place.",
          ],
          ["Not an app."],
          ["An operating environment."],
          [
            "Because the next fight for freedom",
            "will not only be fought in courts, streets, or countries.",
          ],
          ["It will be fought in the systems", "we choose to live inside."],
          [
            "And if the old world gave us platforms",
            "that made us products,",
          ],
          ["then the new world needs environments", "that make us powerful."],
          ["That's what I'm building."],
          [
            "Not because it's easy.",
            "Not because it sounds good.",
            "But because I don't want to spend my life",
            "inside digital rooms built by people",
            "who never cared if I was free.",
          ],
          [
            "So today, while the sky fills with fireworks,",
            "I'm thinking about something else:",
          ],
          ["Who gets to design the world", "we wake up inside tomorrow?"],
          [
            "The strange thing about freedom",
            "is that it's almost never stolen in a single moment.",
          ],
          [
            "It's siphoned away,",
            "quietly,",
            "until dependence feels normal",
            "and alternatives feel impossible.",
          ],
          ["By the time you notice, its already too late"],
        ],
      },
      {
        kind: "quote",
        text: "Freedom is an environment.",
        attribution: "Sean Rock",
      },
      {
        kind: "prose",
        paragraphs: [
          "Sean Rock is Founder & CEO of Jokuh. Spine is the encrypted memory layer at the center of the Sovereign Agentic Operating System—where your conversations, creations, and history live in one place you control.",
        ],
      },
    ],
  },
