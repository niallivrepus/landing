...
> = {
  ...
  "bnb-chain-partnership-discussions": {
    ...
    introParagraphs: [
      "Jokuh has confirmed that **BNB Chain** has opened technical alignment with the company building the Sovereign Agentic Operating System. The conversation began after BNB Chain's ecosystem team independently reviewed Jokuh's pre-seed materials and engaged directly on architectural fit. Both teams are now coordinating ahead of Consensus 2026 in Miami, where the link between Jokuh and the BNB Chain stack is expected to be made visible.",
      "This is the second sovereign-scale chain to engage with Jokuh under the PARTNERSHIP tag in 2026, following the Avalanche grant covering settlement and the marketplace surface. BNB Chain's interest is consistent with what the architecture was built for: agents, identities, and verifiable computation that settle across networks without forcing the user off their preferred chain.",
    ],
    bodyTitle: "How Jokuh maps onto the BNB Chain stack",
    bodyParagraphs: [
      "Jokuh is not retrofitting BNB Chain compatibility, it is building natively across all three layers from day one. **BSC** is the primary economic layer for value flow, marketplace settlement, and agent payments. **opBNB** carries high-throughput, real-time execution where the agent runtime needs sub-second confirmation without compromising on EVM tooling. **Greenfield** is a candidate persistence layer for portions of agent-owned state that need on-chain durability alongside the user-held encrypted memory in Spine.",
      "Each Jokuh agent operates with its own MPC wallet, an ERC-8004 identity for on-chain reputation, and persistent memory that survives across sessions. Agents own value, build verifiable reputations, and earn, and the BNB Chain stack is one of the routes by which that economy clears.",
      "**Why this matters.** BNB Chain operates one of the highest-throughput EVM environments in production, and the BNB Chain ecosystem is one of the largest mainstream user surfaces in Web3. Jokuh's posture is chain-pluralist by design, the user's keys hold across networks, the marketplace settles where it makes sense, and the runtime never assumes a single execution venue. But for the layer where most users will first meet an autonomous agent that owns its own wallet, BNB Chain is a natural lane.",
      "The conversation is early. No commercial terms are signed. The team is treating it the way it has treated every other ecosystem engagement: technical first, marketing second.",
      "\"We're not building a BNB Chain integration. We're architecting natively across BSC, opBNB, and Greenfield from day one, because that's the stack that fits the way Jokuh's agents actually work,\" said **Sean Rock**, Founder & CEO of Jokuh. \"BNB Chain came to us after reviewing the deck. That order matters. We're showing up to Miami ready to demonstrate, not pitch.\"",
      "Coordination ahead of Consensus 2026 in Miami is active. Concrete integration commitments and any public stage moments will be communicated under the PARTNERSHIP and MILESTONE tags once defined.",
      "Jokuh remains in early access. Access, features, availability, pricing, and offers may change and may vary by region, device, account, or plan.",
      "Jokuh. The Sovereign Agentic Operating System. Verify ↔ Trust.",
    ],
  },
