...
import calendarOutline from "../assets/lordicon/outline/calendar.json";
import calendarFilled from "../assets/lordicon/filled/calendar.json";
import callPhoneOutline from "../assets/lordicon/outline/call-phone.json";
import callPhoneFilled from "../assets/lordicon/filled/call-phone.json";
...
export const actionLordicons = {
  ...
  calls: { outline: callPhoneOutline, filled: callPhoneFilled },
  messages: { outline: forumOutline, filled: forumFilled },
  profile: { outline: accountOutline, filled: accountFilled },
  /** Day-grid calendar — matches Spine year timeline / hour capsules. */
  spine: { outline: calendarOutline, filled: calendarFilled },
} as const;
