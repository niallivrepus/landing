...
function Checkbox({ checked = false, onChange, disabled, className }: CheckboxProps) {
  ...
  return (
    <button
      ...
      className={cn(
        "relative flex items-center justify-center min-w-[44px] min-h-[44px] rounded-[4px] outline-none focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background",
