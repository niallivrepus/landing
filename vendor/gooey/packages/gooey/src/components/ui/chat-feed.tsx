...
interface ChatMessageRowProps {
  ...
  side: "left" | "right";
  /** Pass an <Avatar /> here when the speaker should be visually identified. */
...
export function ChatMessageRow({
  ...
  return (
    <div
      ...
      data-chat-message-side={side}
      className={`flex w-full items-start gap-1 ${side === "right" ? "flex-row-reverse justify-end" : ""} ${className}`}
    >
