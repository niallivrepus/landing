...
export function Motivator({ className, onUpgrade }: MotivatorProps) {
  return (
    <div
      className={cn(
        "flex w-full max-w-[474px] flex-col gap-3 rounded-[32px] border border-[var(--color-light-glass-20)] px-4 py-4 backdrop-blur-[25px] sm:h-[58px] sm:flex-row sm:items-center sm:gap-0 sm:rounded-full sm:py-1 sm:pl-6 sm:pr-1",
        className
      )}
      style={{
        background:
