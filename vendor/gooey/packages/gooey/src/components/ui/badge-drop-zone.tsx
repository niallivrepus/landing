      ...
      {BADGES.map((badge, i) => {
        ...
        return (
          <button
            ...
            className="absolute left-0 top-0 overflow-hidden select-none whitespace-nowrap"
            style={{
              height: badgeHeight,
              padding: "0 24px",
          ...
          >
            ...
            >
              <span
                ...
                style={{ backgroundColor: isSelected ? "var(--color-dark-space)" : colors.bg }}
              />
            </GooeyGlass>
