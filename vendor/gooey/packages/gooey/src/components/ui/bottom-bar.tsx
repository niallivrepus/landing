...
const TOP_BAR_CHROME_SCRIM =
  "color-mix(in srgb, var(--color-dark-space) 32%, transparent)";
...
function ScrollForBlurbsTag() {
  return (
    ...
    >
      Scroll for Blurbs
      <div className="pointer-events-none absolute inset-0 rounded-[inherit] shadow-none" />
    </div>
  );
}
...
function TopBar({
  ...
  return (
    <div className={cn("relative w-full", className)}>
      {/* Smooth gradient: soft top chrome → fully transparent at bottom */}
      <div
        className="pointer-events-none absolute inset-0"
        style={{
          background: `linear-gradient(to bottom, ${TOP_BAR_CHROME_SCRIM} 0%, transparent 100%)`,
        }}
      />
