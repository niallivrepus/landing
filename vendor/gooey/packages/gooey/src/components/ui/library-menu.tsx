          ...
          >
            ...
            <div className="flex items-center gap-[4px]">
              <motion.button
                ...
                className="relative inline-flex h-10 shrink-0 items-center rounded-full border focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-white/20"
                style={{
              ...
              {isExpanded && (
                ...
                >
                  {LIBRARY_CHANNELS.map((ch, i) => (
                    ...
                    >
                      <SecondaryButton className="min-h-10 w-fit items-center justify-start gap-0 rounded-full pl-3 pr-4 text-left transition-transform duration-200 hover:-translate-y-[1px] focus-visible:ring-1 focus-visible:ring-white/20">
                        <div
