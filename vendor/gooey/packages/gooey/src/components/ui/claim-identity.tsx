...
function ClaimIdentity({ variant = "get-identity", onClick, className }: ClaimIdentityProps) {
  ...
  return (
    <div
      className={cn(
        "flex h-[80px] items-center justify-between overflow-clip rounded-[20px] border px-3 transition-all duration-200",
        hovered
    ...
    >
      ...
      <div className="shrink-0">
        <IconOnlyButton size="medium" icon={<ChevronRight size={20} />} onClick={onClick} />
      </div>
    </div>
  );
}
