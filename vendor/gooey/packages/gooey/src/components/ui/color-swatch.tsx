    ...
    return (
        <div
            ...
            className={cn(
                ...
                "bg-dark-glass-80 border border-light-glass-20",
                "shadow-none",
        ...
        >
            {COLORS.map((color) => (
                <div key={color.id} className="relative size-2 shrink-0">
                    {value === color.id && (
                        <motion.div
                            className="absolute -inset-[3px] rounded-full border border-[var(--color-light-space)] z-50"
                    ...
                    <button
                        ...
                        disabled={disabled}
                        className="absolute inset-0 rounded-full shadow-none focus-visible:outline-none"
